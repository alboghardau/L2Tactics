    ...
    <div id="mzone">
      ...
      if(isset($_SESSION['username'])&&isset($_SESSION['password']))
        ...
        echo '
                    ...
                    <center>Name: <input type="text" name="artname"/></center>
                     <br/>
                     <center>PageTitle: <input type="text" name="pgtitle"/></center>
                     <br/>
';
        ...
        echo '      
                    ...
                    <center>Keywords<input type="text" name="key"/></center>
                    <center><textarea name="text" style="width: 90%;"></textarea></center>
